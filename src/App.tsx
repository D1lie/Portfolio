  ...
  const services = [
    {
      ...
      description:
        "Systematic process of identifying, analyzing, and prioritizing security weaknesses in applications, networks, and systems to reduce the risk of exploitation.",
      features: [
    ...
    },
    {
      ...
      description:
        "Ethical hacking services to identify vulnerabilities before malicious actors do.",
      features: [
    ...
    },
    {
      ...
      description:
        "Professional vulnerability research and responsible disclosure services.",
      features: [
        "OWASP Top 10",
        "API Security",
        "Mobile App Testing",
    ...
    },
    {
      ...
      description:
        "Building secure applications with security-first development practices.",
      features: [
        "Secure Code Review",
        "DevSecOps",
        "Security Training",
